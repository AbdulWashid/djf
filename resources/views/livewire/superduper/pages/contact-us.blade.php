                        ...
                        @else
                            ...
                            <form wire:submit.prevent="submit" class="flex flex-col gap-4" novalidate>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        <label for="firstname"
                                            ...
                                            First name <span class="text-error"
                                    ...
                                    <div class="col-md-6">
                                        <label for="lastname"
                                               class="block mb-1 text-sm font-medium text-gray-700">
                                            Last name <span class="text-error"
                                                            aria-label="required">*</span>
                                        </label>
                                ...
                                <div  class="col-md-12">
                                    <label for="email"
                                           class="block mb-1 text-sm font-medium text-gray-700">
                                        Email address <span class="text-error"
                                                            aria-label="required">*</span>
                                    </label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    @error('phone')
                                    <span class="block mt-1 text-sm text-error" role="alert">{{ $message }}</span>
                                    @enderror
                                    @error('country_code')
                                    <span class="block mt-1 text-sm text-error" role="alert">{{ $message }}</span>
                                    @enderror
                            ...
                            @if(session('error'))
                                <div
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                         class="h-5 w-5 text-error mr-3 mt-0.5" viewBox="0 0 20 20"
                                         fill="currentColor">
