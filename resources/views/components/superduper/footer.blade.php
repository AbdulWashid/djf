    ...
    <div class="bg-color-denim-darkblue">
                ...
                <div class="container-default">
                    <div class="flex flex-col items-center justify-center gap-16">
                        <div class="max-w-[720px]">
                            <h2
                                class="text-3xl font-medium leading-loose text-center text-gray-100 lg:text-5xl xl:text-4xl">
                                Feel proud of everything you <br /> <span
                                    class="text-5xl font-bold text-secondary-600">Start</span> with <span
                                    class="text-5xl font-bold text-secondary-600">SuperDuper</span>
                            </h2>
                        </div>
        ...
        <div class="text-white">
            <div class="py-[60px] lg:py-20">
                <div class="container-default">
                    <div
                        class="grid gap-x-8 gap-y-10 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-[1fr_repeat(4,_auto)] xl:gap-x-10 xxl:gap-x-[134px]">
                        ...
                        <div class="flex flex-col gap-y-7">
                            ...
                            @php
                                ...
                                $footerCompany = Menu::location('footer');
                            @endphp
                            <ul class="flex flex-col gap-y-[10px] capitalize">
                                @if ($footerCompany)
                                    @foreach ($footerCompany->menuItems as $item)
                                        <li>
                                            <a href="{{ $item->url }}"
