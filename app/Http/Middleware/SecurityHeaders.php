...
class SecurityHeaders
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        if (app()->environment('production')) {
            ...
            $csp = "default-src 'self'; " .
                   "script-src 'self' 'unsafe-inline' 'unsafe-eval' http://localhost:* http://127.0.0.1:* http://[::1]:* https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://static.cloudflareinsights.com; " .
                   ...
                   "connect-src 'self' ws://localhost:* ws://127.0.0.1:* ws://[::1]:* http://localhost:* http://127.0.0.1:* http://[::1]:* https://www.google-analytics.com; " .
                   "media-src 'self'; " .
                   "object-src 'none'; " .
                   "frame-src 'self';";
        }
