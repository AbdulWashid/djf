        ...
        <div class="list-recent-jobs list-job-2-col">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <!-- Item job -->
                    <div class="card-job hover-up wow animate__animated animate__fadeInUp" style="border-color: #FFC107;">
                        <div class="card-job-top">
                            ...
                            <div class="card-job-top--info">
                                <h6 class="card-job-top--info-heading"><a href="{{ route('jobs.show', $job->slug) }}">{{ $job->title }}</a></h6>
                                <div class="row">
                                    <div class="col-lg-7">
                                     <span
                                         class="card-job-top--company">{{ $job->employer->name }}</span>  &nbsp;
                                    ...
                                    <div class="col-lg-5 text-lg-end">
                                        <span class="card-job-top--price">{{ $job->salary_range }}<span>/Year</span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
