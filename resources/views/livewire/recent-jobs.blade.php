                ...
                <div class="card-job hover-up wow animate__animated animate__fadeInUp">
                    <div class="card-job-top">
                        ...
                        <div class="card-job-top--info">
                            <div class="h6 card-job-top--info-heading"><a href="{{ route('jobs.show', $job->slug) }}">{{ $job->title }}</a></div>
                            <div class="row">
                                <div class="col-lg-7">
                                     <span
                                ...
                                <div class="col-lg-5 text-lg-end">
                                    <span class="card-job-top--price">{{ $job->salary_range }}<span> AED/Year</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
