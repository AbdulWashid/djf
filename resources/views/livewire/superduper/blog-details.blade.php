                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-10 lg:grid-cols-[1fr,minmax(416px,_0.45fr)]">
                    <div class="flex flex-col gap-y-10 lg:gap-y-14 xl:gap-y-20">
                        <div class="flex flex-col gap-6">
                            <article class="overflow-hidden bg-white jos">
                                ...
                                <div class="px-[30px]">
                                    ...
                                    <div>
                                        {{-- Post Title --}}
                                        <h1
                                            class="mb-5 mt-8 font-body text-3xl font-bold leading-[1.4] -tracking-[1px] lg:text-4xl">
                                            {{ $post->title }}
                                        </h1>
                                ...
                                <div class="jos bg-color-off-white rounded-[10px] p-8">
                                    <div class="flex flex-col items-center gap-6 sm:flex-row sm:items-start">
                                        <div class="flex-shrink-0 w-20 h-20">
                                            ...
                                            @else
                                                <div
                                                    class="flex items-center justify-center w-full h-full text-2xl text-white rounded-full bg-color-blue">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-4 text-gray-600">
                                                {{ $post->author->description ?? 'Author at ' . config('app.name') }}
                                            </p>
                            ...
                            <div class="grid grid-cols-1 gap-4 jos md:grid-cols-2">
                                @if ($previousPost)
                                    <a href="{{ $previousPost->getUrl() }}"
                                        class="flex flex-col p-6 bg-white rounded-lg shadow-sm group hover:shadow">
                                ...
                                @if ($nextPost)
                                    <a href="{{ $nextPost->getUrl() }}"
                                        class="flex flex-col p-6 text-right bg-white rounded-lg shadow-sm group hover:shadow">
                            ...
                            @if (count($relatedPosts) > 0)
                                <div class="mt-10 jos">
                                    <h3
                                        class="relative mb-[30px] inline-block pb-[10px] text-xl font-semibold text-black after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-full after:bg-black">
                                        Related Posts
                                    </h3>
                                        ...
                                        @foreach ($relatedPosts as $related)
                                            <div
                                                ...
                                                <div class="p-4">
                                                    ...
                                                    <h4
                                                        class="mb-2 font-semibold text-black hover:text-primary-600 line-clamp-2">
                    ...
                    <aside class="lg:sticky lg:top-8 lg:self-start flex flex-col gap-y-[30px]">
                        ...
                        <div class="rounded-[10px] bg-color-off-white p-8">
                            <div
                                class="relative mb-[30px] inline-block pb-[10px] text-lg font-semibold text-black after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-full after:bg-black">
                                Recent Posts
                            </div>
                                ...
                                @foreach ($recentPosts as $recentPost)
                                    <li class="flex flex-col items-center group gap-x-4 gap-y-4 sm:flex-row">
                                        ...
                                        <div class="flex flex-col w-full gap-y-3 sm:w-auto sm:flex-1">
                                            ...
                                            <a href="{{ $recentPost->getUrl() }}"
                                                class="text-base font-semibold text-black line-clamp-2 hover:text-primary-600">
                                                {{ $recentPost->title }}
                                            </a>
                                        </div>
                                    </li>
