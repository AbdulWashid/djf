<div
    x-data="{
        ...
        footerText: @js($attributes->get('footer-text', '© ' . date('Y') . ' Dubai Job Finder. All rights reserved.')),
    }"
    x-init="
        ...
        $watch('$store.form.data.footer_text', value => { footerText = value || '© ' + new Date().getFullYear() + ' Dubai Job Finder. All rights reserved.' });
    "
>
    <div class="p-4 overflow-hidden border border-gray-200 rounded-lg bg-gray-50">
        <div class="p-4 text-center text-white rounded-t-lg" x-bind:style="'background-color: ' + primaryColor">
            <div class="mb-0">
                ...
                <template x-if="!logoPath">
                    <div class="text-xl font-bold">Dubai Job Finder</div>
                </template>
            </div>
        </div>
        ...
        <div class="p-6 bg-white border-gray-200 border-x">
            ...
            <h2 class="mb-4 text-xl font-semibold" x-bind:style="'color: ' + primaryColor">
                Test Email from Dubai Job Finder
            </h2>
